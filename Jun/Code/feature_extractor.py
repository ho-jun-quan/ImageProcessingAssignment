"""
feature_extractor.py — Extract geometric features from skeletonised particle
tracks for Random Forest classification.

Each track produces a 12-element feature vector derived from its skeleton
topology and the binary mask geometry.
"""
