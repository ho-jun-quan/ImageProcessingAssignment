...
# =============================================================================
# Every detected track skeleton is resized to this fixed (height, width) grid
# and flattened into a binary pixel vector. These pixels ARE the features the
# Random Forest is trained on.
SKELETON_IMG_SIZE = (32, 32)
